...
class Users(Base):
    ...
    user_id = Column(
        NUMBER, Sequence(db_user + ".user_id_seq"), primary_key=True
    )
...
class Folders(Base):
    ...
    folder_id = Column(
        NUMBER, Sequence(db_user + ".folder_id_seq"), primary_key=True
    )
    folder_name = Column(VARCHAR2(255))
    user_id = Column(
        NUMBER,
        ForeignKey(DB_USER + ".Users.user_id", ondelete="CASCADE"),
        nullable=False,
    )
...
class Links(Base):
    ...
    link_id = Column(
        NUMBER, Sequence(db_user + ".link_id_seq"), primary_key=True
    )
...
class Vectors(Base):
    ...
    vector_id = Column(
        NUMBER, Sequence(db_user + ".vector_id_seq"), primary_key=True
    )
    ...
    link_id = Column(
        NUMBER,
        ForeignKey(DB_USER + ".Links.link_id", ondelete="CASCADE"),
        nullable=False,
    )
...
class ChatRooms(Base):
    ...
    room_id = Column(
        NUMBER, Sequence(db_user + ".room_id_seq"), primary_key=True
    )
    ...
    folder_id = Column(
        NUMBER,
        ForeignKey(DB_USER + ".Folders.folder_id", ondelete="CASCADE"),
        nullable=False,
    )
...
class Link_Chatrooms(Base):
    ...
    link_room_id = Column(
        NUMBER, Sequence(db_user + ".link_room_id_seq"), primary_key=True
    )
    link_id = Column(
        NUMBER,
        ForeignKey(DB_USER + ".Links.link_id", ondelete="CASCADE"),
    ...
    room_id = Column(
        NUMBER,
        ForeignKey(DB_USER + ".ChatRooms.room_id", ondelete="CASCADE"),
        nullable=False,
    )
...
class Messages(Base):
    ...
    room_id = Column(
        NUMBER, ForeignKey(DB_USER + ".ChatRooms.room_id"), nullable=False
    )
...
class Scores(Base):
    ...
    score_id = Column(
        NUMBER, Sequence(db_user + ".score_id_seq"), primary_key=True
    )
    score = Column(NUMBER(1), nullable=False)  # Limited to a single digit (0-9)
    msg_id = Column(
        NUMBER, ForeignKey(DB_USER + ".Messages.msg_id"), nullable=False
    )
